...
with open("/Users/noledge/Downloads/training_set/sequences/1.txt", "r", encoding="utf-8") as f:
    lignes = f.readlines()
...
with open("/Users/noledge/Downloads/training_set/annotations_revised_training.txt", "r", encoding="utf-8") as f:
    lignes2 = f.readlines()
